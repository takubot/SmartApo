...
export type PremiseSection = {
  title: string;
  fields: PremiseField[];
};

export const FIELD_TYPE_LABEL: Record<PremiseFieldType, string> = {
  string: "短い回答",
  text: "長い回答",
  url: "URL",
  select: "選択肢（1つ）",
...
export const FIELD_TYPE_DESCRIPTION: Record<PremiseFieldType, string> = {
...
export function newField(): PremiseField {
  return {
    key: "",
    label: "",
    type: "string",
...
export function newSection(): PremiseSection {
  return {
    title: "",
    fields: [newField()],
  };
