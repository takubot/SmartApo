...
function ChartCard({
  ...
  return (
    <Card className="h-full border border-default-200 flex flex-col min-h-0">
    ...
    <div className="space-y-2 sm:space-y-3 mt-2 sm:mt-3">
          ...
          {chartData.length > 0 ? (
            ...
            <div className="flex-1 flex items-center justify-center text-default-400 min-h-0">
              <div className="text-center px-2">
                <Activity className="w-5 h-5 mx-auto mb-0.5 opacity-50" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        <Card className="border border-default-200">
          ...
          <CardBody className="pt-1.5 px-2 pb-2">
