...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_FAVICON: process.env.NEXT_PUBLIC_FAVICON || "smartapo.ico",
    NEXT_PUBLIC_META_TITLE: process.env.NEXT_PUBLIC_META_TITLE || "SmartApo",
    NEXT_PUBLIC_META_DESCRIPTION:
      process.env.NEXT_PUBLIC_META_DESCRIPTION || "SmartApo",
